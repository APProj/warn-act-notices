...
(40,293 notices) and the zero-delay feed are the commercial products
...
expensive part. As of 2026-09-01: **81 notices** affecting 7,084 workers (dated in the last 45 days, 10 states) are in the real-time feed and not yet in this repo's free files — each lands here only after its 48-hour delay. Machine-readable: `delay_gap` in [`data/coverage.json`](data/coverage.json).
